		...
		rules: [
			...
			},
			{
				test: /\.scss$/, use: [
					...
					// (also requires a declaration.d.ts with "declare modules '*.scss';" in it to tell TypeScript that "import styles from
					// './styles.scss';" means to load the module "./styles.scss.d.td")
